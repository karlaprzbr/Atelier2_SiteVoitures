...
<head>
    ...
    <meta name='description' content='SH Auto - Achats et ventes de véhicules d' occasion ' /><meta name='author ' content='potenzaglobalsolutions.com ' /><meta name='viewport ' content='width=device-width, initial-scale=1, maximum-scale=1 ' /><title>SH Auto - Achats et ventes de véhicules d'occasion</title>
...
<body>
        ...
        <div class='container'>
            <div class='row text-center intro-title'>
                <div class='col-md-6 text-md-left d-inline-block'>
                    <h1 class='text-white'>Peugeot 206 + 1.1 Urban</h1></div>
    ...
    <section class='car-details page-section-ptb'>
        <div class='container'>
            <div class='row'>
                <div class='col-md-9'>
                    <h3> Peugeot 206 + 1.1 Urban </h3></div>
                <div class='col-md-3'>
                                        ...
                                        <div class='modal-content'>
                                            ...
                                            <div class='modal-body'>
                                                ...
                                                <form class='gray-form reset_css' id='rendezVousForm' action=''>
                                                    ...
                                                    <input type='hidden' name='reference' value='206PlusWhite' />
                ...
                <div class='col-md-8'>
                    <div class='slider-slick'>
                        <div class='slider slider-for detail-big-car-gallery'>
                            ...
                            <img class='img-fluid' src='../images/detail/big/206PlusWhite/4.jpg' alt=''>
                        ...
                        <div class='slider slider-nav'>
                            <img class='img-fluid' src='../images/detail/thum/206PlusWhite/1.jpg' alt=''>
                            ...
                            <img class='img-fluid' src='../images/detail/thum/206PlusWhite/4.jpg' alt=''>
        ...
        <div class='container'>
            ...
            <div class='row'>
                <div class='col-lg-3 col-md-6'>
                    <div class='about-content'><img class='img-fluid' id='logo-footer' src='../images/logo2.png' alt='' style='filter: brightness(0) invert(1);'>
                        <p id='company-name' style="font-family:'Sonsie One', cursive;color:white;margin-top: 10px;"> SH Auto</p>
                ...
                <div class='col-lg-3 col-md-6'>
                    <div class='news-letter'>
                        ...
                        <form class='news-letter'>
                            <input type='email' placeholder='Entrez votre courriel' class='form-control placeholder'><a class='button red' href='#'>S'inscrire</a></form>
                    </div>
                </div>
            </div>
            <hr />
